 ...
 */
final class Version20220916140612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE description description LONGTEXT NOT NULL, CHANGE program_id_id program_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE description description LONGTEXT DEFAULT NULL, CHANGE program_id program_id_id INT NOT NULL');
